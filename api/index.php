...
require_once 'api_admin_login.php';
require_once 'api_admin_password.php';
require_once 'api_admin_manage.php';
require_once 'api_admin_list.php';

require_once 'api_media_manage.php';
require_once 'api_media_list.php';

require_once 'api_game_manage.php';
require_once 'api_game_list.php';

require_once 'api_activity_manage.php';
require_once 'api_activity_list.php';

require_once 'api_score.php';

require_once 'api_user_file.php';
require_once 'api_user_login.php';
require_once 'api_user_manage.php';
require_once 'api_user_list.php';

//require_once 'api_tools.php';
